...
export default function AdminProductEditScreen() {
  ...
  const uploadHandler = async (e, imageField = 'image') => {
    const url = `https://api.cloudinary.com/v2_1/${process.env.NEXT_PUBLIC_CLOUDINARY_CLOUD_NAME}/upload`
    try {
...
//                   className="w-full"
//                   id="brand"
//                   {...register('brand', { required: 'Please enter name' })}
//                 />
//                 {errors.brand && (
